...
public class TestC extends BaseJunitTest {
    @Test
  public  void testHanLp (){
      //System.out.println(HanLP.segment("您好，欢迎使用Hanlp"));
        String str  = "中国科学院计算技术研究所的宗成庆教授正在教授自然语言处理课程";
        List<Term> termList  = HanLP.segment("十九大和中国政府");
      List<Term> terms = HanLP.segment(str);
        System.out.println(termList);
        System.out.println(terms);

        List<Term> term1 = TraditionalChineseTokenizer.segment("大衛貝克漢不僅僅是名著名球員，球場以外，其妻為前辣妹合唱團成員維多利亞·碧咸，亦由於他擁有突出外表、百變髮型及正面的形象，以至自己品牌的男士香水等商品，及長期擔任運動品牌Adidas的代言人，因此對大眾傳播媒介和時尚界等方面都具很大的影響力，在足球圈外所獲得的認受程度可謂前所未見。");
...
public  void NameRecognize(){
        String[] testCase = new String[]{
                "签约仪式前，秦光荣、李纪恒、仇和、习近平、李克强等一同会见了参加签约的企业家。",
...
@Test
public void TranslateNameRecognize(){
    String[] testCase = new String[]{
            "一桶冰水当头倒下，微软的比尔盖茨、Facebook的扎克伯格跟桑德博格、亚马逊的贝索斯、苹果的库克全都不惜湿身入镜，这些硅谷的科技人，飞蛾扑火似地牺牲演出，其实全为了慈善。",
            "世界上最长的姓名是简森·乔伊·亚历山大·比基·卡利斯勒·达夫·埃利奥特·福克斯·伊维鲁莫·马尔尼·梅尔斯·帕特森·汤普森·华莱士·普雷斯顿。特狼普是美国总统",
    };
...
public  void OrganizationRecognize(){
    ...
    {
        List<Term> termList = segment.seg(sentence);
        List<Term> termList1 = segment1.seg(sentence);
        System.out.println(termList);
...
public  void ExtractPhrase(){
    String text = "算法工程师\n" +
            ...
            "算法工程师逐渐往人工智能方向发展。";
    List<String> phraseList = HanLP.extractPhrase(text, 2);
